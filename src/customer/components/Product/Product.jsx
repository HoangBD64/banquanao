...
export default function Product() {
  ...
  const handleFilter = (value, sectionId) => {
    ...
    // Nếu giá trị đã tồn tại trong bộ lọc, thì xóa nó
    ...
    navigate({ search: `?${query}` }); // Điều hướng tới URL mới
  };
      ...
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-1">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-2 gap-y-10 lg:grid-cols-5">
              {/* Filters */}
              <div>
              ...
              {/* Product grid */}
              <div className="grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:col-span-4">
